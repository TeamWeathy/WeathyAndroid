package team.weathy.util.snowfall
...
class SnowfallView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val snowflakesImageRatio: Float
    private val snowflakesSameDirection: Boolean
    ...
    init {
        ...
        try {
            ...
            snowflakeSizeMinInPx = a.getDimensionPixelSize(
                R.styleable.SnowfallView_snowflakeSizeMin, dpToPx(DEFAULT_SNOWFLAKE_SIZE_MIN_IN_DP)
            )
            ...
            snowflakesImageRatio =
                a.getFloat(R.styleable.SnowfallView_snowflakesImageRatio, DEFAULT_SNOWFLAKES_IMAGE_RATIO)
            snowflakesSameDirection =
                a.getBoolean(R.styleable.SnowfallView_snowflakesSameDirection, DEFAULT_SNOWFLAKES_SAME_DIRECTION)
    ...
    private fun createSnowflakes(): Array<Snowflake> {
        ...
        val snowflakeParams = Snowflake.Params(
            ...
            imageRatio = snowflakesImageRatio,
            sameDirection = snowflakesSameDirection,
        )
    ...
    companion object {
        ...
        private const val DEFAULT_SNOWFLAKES_IMAGE_RATIO = 1f
        private const val DEFAULT_SNOWFLAKES_SAME_DIRECTION = false
    }
}